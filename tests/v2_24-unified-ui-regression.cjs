...
test('V2.24 folder cards use only the user supplied app icon and no folder layers',()=>{
...
test('V2.24 folder create and change-icon previews show the app icon only',()=>{
...
test('V2.24 has a persistent desktop sidebar rail and a mobile full-sidebar toggle',()=>{
  const ui=read('public/ui/app.js'),css=read('public/ui/app.css');
...
test('V2.24 applies File Manager page width and control geometry across the app',()=>{
