...
test('V2.23 matches the approved full-width responsive File Manager structure',()=>{
...
test('V2.23 account toolbar is reduced to search and New Folder',()=>{
...
test('V2.23 has global search that can jump to files and folders',()=>{
  const ui=read('public/ui/app.js');
...
test('V2.23 folder icons are manual only and use the supplied base folder artwork',()=>{
  const ui=read('public/ui/app.js');
...
test('V2.23 right-click management supports folder and file rename/delete',()=>{
