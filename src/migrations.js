...
async function createCoreTables(db) {
  ...
  await db.query(`CREATE TABLE IF NOT EXISTS apps (
    ...
    category_slug VARCHAR(160) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
    ...
    current_version VARCHAR(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
    description MEDIUMTEXT NULL,
    official_url TEXT NULL,
    source_page_url TEXT NOT NULL,
    source_package_id VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
    source_updated_at DATE NULL,
    source_metadata_json LONGTEXT NULL,
    apk_type VARCHAR(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
    architecture VARCHAR(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
    ...
    latest_version VARCHAR(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
  ...
  for (const [column, definition] of [
    ...
    ['category_slug', 'VARCHAR(160) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL AFTER source_section'],
  ...
  await db.query(`CREATE TABLE IF NOT EXISTS apk_categories (
    ...
    parent_slug VARCHAR(160) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
  ...
  await db.query(`CREATE TABLE IF NOT EXISTS apk_versions (
    ...
    version VARCHAR(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
    source_page_url TEXT NULL,
    file_size_bytes BIGINT UNSIGNED NULL,
    architecture VARCHAR(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
    apk_type VARCHAR(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
    release_date DATE NULL,
    release_date_source VARCHAR(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  ...
  await db.query(`CREATE TABLE IF NOT EXISTS apk_sync_state (
    sync_key VARCHAR(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL PRIMARY KEY,
    status VARCHAR(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'idle',
    mode VARCHAR(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'daily',
  ...
  await ensureColumn(db,'apk_sync_state','run_id','VARCHAR(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL');
  ...
  await db.query(`CREATE TABLE IF NOT EXISTS apk_update_state (
    scan_key VARCHAR(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL PRIMARY KEY,
    status VARCHAR(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'idle',
    queue_json LONGTEXT NULL,
    total_count INT NOT NULL DEFAULT 0,
    processed_count INT NOT NULL DEFAULT 0,
  ...
  await ensureColumn(db,'apk_update_state','run_id','VARCHAR(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL');
  ...
  await db.query(`CREATE TABLE IF NOT EXISTS notifications (
    ...
    type VARCHAR(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'info',
    title VARCHAR(160) NOT NULL,
    message VARCHAR(700) NULL,
    app_id BIGINT UNSIGNED NULL,
    target_user_id BIGINT UNSIGNED NULL,
    dedupe_key VARCHAR(190) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
  ...
  await db.query(`CREATE TABLE IF NOT EXISTS app_work_claims (
    app_id BIGINT UNSIGNED NOT NULL PRIMARY KEY,
    user_id BIGINT UNSIGNED NOT NULL,
    lock_token VARCHAR(96) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  await db.query(`CREATE TABLE IF NOT EXISTS backup_history (
    id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
    backup_kind VARCHAR(24) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  await db.query(`CREATE TABLE IF NOT EXISTS r2_accounts (
    id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
    label VARCHAR(160) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
    enabled TINYINT(1) NOT NULL DEFAULT 1,
    cloudflare_account_id VARCHAR(80) CHARACTER SET ascii COLLATE ascii_general_ci NOT NULL,
    bucket_name VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
    access_key_id VARCHAR(255) CHARACTER SET ascii COLLATE ascii_general_ci NOT NULL,
    secret_encrypted TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
    folder_prefix VARCHAR(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
    endpoint_url VARCHAR(500) CHARACTER SET ascii COLLATE ascii_general_ci NULL,
    region VARCHAR(40) CHARACTER SET ascii COLLATE ascii_general_ci NOT NULL DEFAULT 'auto',
    link_mode ENUM('direct','gateway') NOT NULL DEFAULT 'gateway',
    direct_domain VARCHAR(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
    gateway_domain VARCHAR(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
    storage_target_bytes BIGINT UNSIGNED NOT NULL DEFAULT 10737418240,
    last_test_status ENUM('not_tested','success','failed') NOT NULL DEFAULT 'not_tested',
    last_test_message VARCHAR(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
    last_test_at DATETIME NULL,
    last_sync_at DATETIME NULL,
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    UNIQUE KEY uniq_r2_account_bucket (cloudflare_account_id,bucket_name),
    INDEX idx_r2_account_enabled (enabled,id)
  ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci`);

  await db.query(`CREATE TABLE IF NOT EXISTS r2_objects (
    id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
    ...
    content_type VARCHAR(180) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
    size_bytes BIGINT UNSIGNED NOT NULL DEFAULT 0,
    etag VARCHAR(255) CHARACTER SET ascii COLLATE ascii_general_ci NULL,
    last_modified DATETIME NULL,
    public_token CHAR(48) CHARACTER SET ascii COLLATE ascii_general_ci NOT NULL,
    source ENUM('sync','upload') NOT NULL DEFAULT 'sync',
    last_seen_at DATETIME NULL,
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    UNIQUE KEY uniq_r2_object_key (account_id,key_hash),
    UNIQUE KEY uniq_r2_public_token (public_token),
    INDEX idx_r2_objects_account_modified (account_id,last_modified),
  ...
  await db.query(`CREATE TABLE IF NOT EXISTS r2_uploads (
    ...
    account_id BIGINT UNSIGNED NOT NULL,
    r2_upload_id VARCHAR(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
    object_key TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
    filename VARCHAR(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
    file_size_bytes BIGINT UNSIGNED NOT NULL,
    content_type VARCHAR(180) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
    last_modified_ms BIGINT UNSIGNED NULL,
    part_size_bytes BIGINT UNSIGNED NOT NULL,
    uploaded_bytes BIGINT UNSIGNED NOT NULL DEFAULT 0,
    parts_json LONGTEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
    status ENUM('starting','uploading','completing','completed','aborted','error') NOT NULL DEFAULT 'starting',
    error_message VARCHAR(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
    replace_object_id BIGINT UNSIGNED NULL,
    public_token CHAR(48) CHARACTER SET ascii COLLATE ascii_general_ci NOT NULL,
    created_by BIGINT UNSIGNED NULL,
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    completed_at DATETIME NULL,
    UNIQUE KEY uniq_r2_upload_token (upload_token),
    INDEX idx_r2_uploads_account_status (account_id,status,updated_at),
    CONSTRAINT fk_r2_uploads_account FOREIGN KEY (account_id) REFERENCES r2_accounts(id) ON DELETE CASCADE,
    CONSTRAINT fk_r2_uploads_user FOREIGN KEY (created_by) REFERENCES users(id) ON DELETE SET NULL
  ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci`);

  await db.query(`CREATE TABLE IF NOT EXISTS r2_download_domains (
    id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
    ...
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    UNIQUE KEY uniq_r2_download_hostname (hostname),
    UNIQUE KEY uniq_r2_download_token (verification_token),
    INDEX idx_r2_download_active (active,id)
  ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci`);
}
...
async function recoverFileSizesFromMetadata(db) {
  if (!(await tableExists(db,'apps'))) return 0;
  let lastId=0,updated=0;
  const hasMetadataTable=await tableExists(db,'apk_metadata');
  while(true){
    const [rows]=await db.query(`SELECT id,current_version,file_size_bytes,source_metadata_json FROM apps
      WHERE id>? AND (file_size_bytes IS NULL OR file_size_bytes=0) AND source_metadata_json IS NOT NULL
      ORDER BY id LIMIT 500`,[lastId]);
    if(!rows.length)break;
    for(const row of rows){
      lastId=Number(row.id);
      let meta={};try{meta=JSON.parse(row.source_metadata_json||'{}')}catch{continue}
      const sourceVersion=String(meta.version||'').trim(),managedVersion=String(row.current_version||'').trim();
      if(sourceVersion&&managedVersion&&sourceVersion!==managedVersion)continue;
      const candidates=[meta.fileSizeBytes,meta.size,meta.fileSize,meta.file_size,meta.apkSize,meta.appSize,meta.downloadSize,meta.packageSize];
      let bytes=null;for(const candidate of candidates){bytes=apkFields.parseBytes(candidate);if(bytes)break}
      if(!bytes)continue;
      meta.fileSizeBytes=bytes;
      if(!meta.size)meta.size=bytes;
      if(Array.isArray(meta.missingFields))meta.missingFields=meta.missingFields.filter(x=>String(x).toLowerCase()!=='size');
      await db.query('UPDATE apps SET file_size_bytes=?,source_metadata_json=?,metadata_updated_at=COALESCE(metadata_updated_at,NOW()) WHERE id=?',[bytes,JSON.stringify(meta),row.id]);
      if(hasMetadataTable)await db.query('INSERT INTO apk_metadata (app_id,metadata_json) VALUES (?,?) ON DUPLICATE KEY UPDATE metadata_json=VALUES(metadata_json)',[row.id,JSON.stringify(meta)]);
      updated++;
    }
  }
  return updated;
...
module.exports = { migrate, normalizeAppbitCollations, recoverFileSizesFromMetadata, SCHEMA_VERSION };
