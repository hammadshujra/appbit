# Appbit V2.22 — Hostinger App Hosting
...
```text
[Appbit] Hostinger prebuild V2.22: API route verified — pages/api/[[...path]].js (Next.js module syntax).
[Appbit] Hostinger output finalized for V2.22.
```
...
1. Push the V2.22 files to the exact `main` branch selected in Hostinger.
...
1. Create **one CNAME** record: the custom hostname as the Name and the Appbit gateway hostname as the Target. There is **no TXT record** in V2.22.
